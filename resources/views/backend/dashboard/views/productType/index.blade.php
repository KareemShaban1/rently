...
@section('content')
    <a href="#" class="btn btn-primary er fs-6 px-8 py-4 mb-5" data-bs-toggle="modal"
        data-bs-target="#kt_modal_new_product_type">{{ trans('backend.Add_product_type') }}</a>


    @include('backend.dashboard.views.productType.add_product_type_modal')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_edit_product_type{{ $type->id }}">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        @include('backend.dashboard.views.productType.edit_product_type_modal')

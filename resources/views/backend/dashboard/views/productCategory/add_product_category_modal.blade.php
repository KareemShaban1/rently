<div class="modal fade" id="kt_modal_new_product_category" tabindex="-1" aria-hidden="true" style="direction: ltr">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_modal_new_product_category_form" class="form" enctype="multipart/form-data"
                    action="{{ route('productCategory.store') }}" method="POST">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ trans('backend.Add_product_category') }}</h1>
                        <!--end::Title-->
                    ...
                    <div class="row">
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">{{ trans('backend.Description') }}</span>
                            </label>

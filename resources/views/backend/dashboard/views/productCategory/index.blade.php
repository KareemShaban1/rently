...
@section('content')
    <a href="#" class="btn btn-primary er fs-6 px-8 py-4 mb-5" data-bs-toggle="modal"
        data-bs-target="#kt_modal_new_product_category">{{ trans('backend.Add_product_category') }}</a>


    @include('backend.dashboard.views.productCategory.add_product_category_modal')
                            ...
                            @foreach ($productCategories as $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('backend.dashboard.views.productCategory.edit_product_category_modal')

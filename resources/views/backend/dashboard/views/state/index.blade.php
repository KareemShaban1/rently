...
@section('page-title')
    <div class="page-title d-flex flex-column me-5">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">{{ trans('backend.All_Cities') }}</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('content')
    <a href="#" class="btn btn-primary er fs-6 px-8 py-4 mb-5" data-bs-toggle="modal"
        data-bs-target="#kt_modal_new_state">{{ trans('backend.Add_State') }}</a>


    @include('backend.dashboard.views.state.add_state_modal')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_edit_state{{ $state->id }}">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        @include('backend.dashboard.views.state.edit_state_modal')

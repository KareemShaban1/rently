<div class="modal fade" id="kt_modal_edit_city{{ $city->id }}" tabindex="-1" aria-hidden="true" style="direction: ltr">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_modal_new_city_form" class="form" enctype="multipart/form-data"
                    action="{{ route('city.update', $city) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ trans('backend.Edit_City') }}</h1>
                        <!--end::Title-->
                    ...
                    <div class="text-center">
                        <button type="reset" id="kt_modal_new_city_cancel" data-bs-dismiss="modal"
